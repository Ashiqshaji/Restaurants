...
// initialView: 'dayGridMonth',
// selectable: true,
// headerToolbar: false, // Hide the header toolbar
// dayCellDidMount: function(info) {
// if (info.dateStr === new Date().toISOString().split('T')[0]) {
// info.el.classList.add('highlight-today');
// }
...
// // Update modal or any other UI elements if needed
// updateModalDateInfo(dateStr);
// }

// function updateModalDateInfo(dateStr) {
