            ...
            <div class="col-12">
              <div id="carouselExampleIndicators" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                <div class="row text-center">
                  @for ($i = 0; $i <= (7 * 2 + 1); $i++) @php $time=\Carbon\Carbon::createFromTime(8, 0)->addMinutes($i * 60);
                    $timeStr = $time->format('H:i');
                    $buttonId = 'btn-' . $time->format('Hi');

                    @endphp
                    <div class="col-3 p-1">
                      <a id="{{ $buttonId }}" href="#" class="btn btn-primary time-slot-btn" tabindex="-1" role="button" data-time="{{ $timeStr }}">{{ $time->format('h:i a') }}</a>
                    </div>
                    @endfor
                </div>
              </div>
            ...
            <div class="col-12 mt-4">
              ...
              <div class="col-12">
                <div class="submit_button">
                  <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" id="ConfirmModal_Reservation" data-bs-target="#ConfirmModal">Make a Reservation</button>
                </div>
              </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="ConfirmModalLabel">Please re-Confirm the details for reservation</h1>
          ...
          <form>
            <div class="mb-3">
              ...
              <div class="booking_date">
                <p><strong><span id="modalDay"></span>,<span id="modalMonth"></span> , <span id="modalDate"></span> </strong>at <span id="selectedTime"></span> </p>
        ...
        <div class="modal-footer" id="modalFooter_ConfirmModal" style="display: flex;justify-content: space-around;align-items: center;">


          <button type="button" class="btn btn-reservation" id="Reservation_Save">Confirm</button>
          <button type="button" class="btn btn-reservation" id="Reservation_Modify" data-bs-dismiss="modal">Modify</button>
        </div>

        <div class="modal-footer" id="loading" style="display: None;justify-content: space-around;align-items: center;">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-reservation" id="reservation_close" data-bs-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
  </div>
