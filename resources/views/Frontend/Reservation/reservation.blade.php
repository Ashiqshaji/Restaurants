                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12  mb-1">
                                                    <div class="date_header">
                                                        <h6 class="mb-0" id="dayDisplay"></h6>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-12">
                                                    <input type="hidden" id='page_date' name="page_date">
                                                    <div class="date_date">
                                                        <h5 class="mb-0" id="dateDisplay"></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-8">
                                    <div class="d-flex align-items-center border rounded p-2">
                                        <div class="flex-grow-1">
                                            ...
                                            <h6 class="mb-0" id="TimeDisplay">02:58:00 PM</h6>
                                            <input type="hidden" id="page_date" name="page_date">
                                        </div>
                                        <!-- Time Dropdown Toggle -->
                                        <div class="ms-2" onclick="toggleTimeDropdown()" style="cursor: pointer;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                                fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                                                <path
                                                    d="M8 3.5a.5.5 0 0 1 .5.5v4.343l3.672 3.672a.5.5 0 0 1-.708.708L8.5 8.993V4a.5.5 0 0 1 .5-.5z" />
                                                <path fill-rule="evenodd"
                                                    d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zM8 15a7 7 0 1 1 0-14 7 7 0 0 1 0 14z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <!-- Time Dropdown -->
                                    <div id="timeDropdown"
                                        style="display: none; position: absolute; z-index: 999; border: 1px solid #ccc; background-color: white; padding: 10px;">
                                        <select id="timeDropdownSelect" class="form-control">
