...
<div id="list_date_reservation" class="card">
    <div class="card-body">
        ...
        <div class="row gap-2 ">
                                ...
                                <div class="col-5" style="display: flex;padding: 20px 20px;align-items: center;">
                                    ...
                                    <div class="list-box-details">
                                        <div class="list-box-details-name">
                                            <span>{{ ucwords($table_list_null1->customer_name) }}</span>
                                        </div>
                                        ...
                                        <div class="list-box-details-email">
                                            <span>{{ $table_list_null1->email }}<span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="list-box-number">
                                        ...
                                        <div class="list-box-number-count">
                                            <p>{{ $table_list_null1->no_of_people }}</p>
                                        </div>
                                ...
                                <div class="col-5">
                                    <div class="list-box-table">
                                        ...
                                        <div id="list-box-table-button" class="list-box-table-button">
                                            <a
                                                href="{{ route('admin.assigntable', ['id' => Crypt::encrypt($table_list_null1->table_id)]) }}">
            ...
            @foreach ($notNulltable as $table_list_notnull2)
                @php
                            ...
                            <div class="row" style="display: flex; align-items: center; align-content: center;">
                                <div class="col-12">
                                    <div class="table-status" style="display: flex;flex-direction: row-reverse;">
                                        ...
                                        @elseif ($table_list_notnull2->Status === 'checkedin')
                                            <span class="badge " style="background-color: {{ $badgeColor }};">Checked
                                                In</span>
                                        @endif
                                ...
                                <div class="col-5" style="display: flex; padding: 20px 20px; align-items: center;">
                                    ...
                                    <div class="list-box-details">
                                        <div class="list-box-details-name">
                                            <span>{{ ucwords($table_list_notnull2->customer_name) }}</span>
                                        </div>
                                        <div class="list-box-details-number">
                                            @php
                                                $formattedMobileNo =
                                        ...
                                        <div class="list-box-details-email">
                                            <span>{{ $table_list_notnull2->email }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="list-box-number">
                                        ...
                                        <div class="list-box-number-count">
                                            <p>{{ $table_list_notnull2->no_of_people }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="list-box-table">
                                        ...
                                        <div class="list-box-table-button"
                                            ...
                                            <div class="edit-list-table" style="padding: 0px 5px;">
                                                <span>{{ $table_list_notnull2->table_no }}</span>
                                            </div>
                                    ...
                                    <span>Status:
                                        {{ ucwords($table_list_notnull2->Status) }}</span>
                                </div> --}}
                                </div>
                            </div>
                        </div>
